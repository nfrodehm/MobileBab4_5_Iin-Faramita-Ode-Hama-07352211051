...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Center(
        child: Text('Welcome to The Jungle', style: TextStyle(fontSize: 24)),
      ),
    );
  }
}
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                // Kembali ke halaman awal (SplashScreen/HomeScreen)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Expanded(
            child: products.isNotEmpty // Periksa apakah produk ada
                ? ListView.builder(
...
class FreelancerList extends StatelessWidget { //kelas freelance
    ...
    return Column(
        children: [
          BestBookingCard(
            ...
            profileUrl: 'assets/images/8.png',
            name: 'Miss Zachary Will',
            role: 'Beautician',
          ...
          BestBookingCard(
            ...
            profileUrl: 'assets/images/9.png',
            name: 'Miss Zachary Will',
            role: 'Beautician',
            description: 'Occaecati aut nam beatae quo non deserunt consequatur.',
            rating: 4.9,
            ...
            Stack(
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/6.png', // Ganti dengan path gambar Anda
                    height: 230,
                    width: double.infinity,
                    fit: BoxFit.cover,
                  ),
